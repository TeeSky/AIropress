...
struct MockBrewVars {
    ...
    static let bitternessLabelSet = VariableLabelSet(
        mainLabel: "Bitterness",
        minLabel: "Watery",
        maxLabel: "Bitter"
    )
    ...
    static let flavourVariable = BrewVariable(
        id: 2,
        stepCount: 10,
        labelSet: VariableLabelSet(
            mainLabel: "Flavour",
            minLabel: "Light",
            maxLabel: "Full"
        )
    ...
    static let tasteBundle = BrewVariableBundle(
        label: "Taste",
        variables: [bitternessVariable, flavourVariable]
    )
    static let tasteInitialValues = [
        bitternessVariable: bitternessVariableValue,
        flavourVariable: flavourVariableValue
    ]

    static let acidityBundle = BrewVariableBundle(
        label: "Acidity",
        variables: [
            BrewVariable(
                id: 3,
    ...
    static let constants: [RecipeConstant] = [
        RecipeConstant(id: RecipeValue.waterAmount.rawValue, value: 85),
    ...
    static let semiConstants: [RecipeSemiConstant] = [
        RecipeSemiConstant(
            id: RecipeValue.temperature.rawValue,
            value: 86,
            confidenceVariableId: 10,
            initialConfidenceValue: 0.8
        ),
        RecipeSemiConstant(
            id: RecipeValue.hiddenValuePlaceholder.rawValue,
            value: 30,
            confidenceVariableId: 13,
            initialConfidenceValue: 0.6
        ), // Semi constant should not normally be hidden
        RecipeSemiConstant(
            id: RecipeValue.grindSize.rawValue,
            value: 28,
            confidenceVariableId: 11,
            initialConfidenceValue: 0.5
        )
    ]

    static let recipe: BrewRecipe = BrewRecipe(constants: constants, semiConstants: semiConstants)

    static let recipeValues: [Int: Double] = [
        RecipeValue.aeropressOrientation.rawValue: AeropressBrewOrientation.inverted.value(),
...
class BrewVariableTests: XCTestCase {
    ...
    func testHash() {
        ...
        let brewVariableWithExpectedHash = BrewVariable(
            id: brewVariableId,
            stepCount: 15,
            labelSet: MockBrewVars.bitternessLabelSet
        )
        let brewVariableWithUnexpectedHash = BrewVariable(
            id: otherBrewVariableId,
            stepCount: 10,
            labelSet: MockBrewVars.bitternessLabelSet
        )
