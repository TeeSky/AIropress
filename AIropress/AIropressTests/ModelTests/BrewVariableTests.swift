...
struct MockBrewVars {
    ...
    static let bitternessLabelSet = VariableLabelSet(mainLabel: "Bitterness",
                                                     minLabel: "Watery", maxLabel: "Bitter")
    ...
    static let flavourVariable = BrewVariable(id: 2, stepCount: 10, labelSet: VariableLabelSet(mainLabel: "Flavour",
                                                                                               minLabel: "Light", maxLabel: "Full"))
    ...
    static let semiConstants: [RecipeSemiConstant] = [RecipeSemiConstant(id: RecipeValue.temperature.rawValue, value: 86,
                                                                         confidenceVariableId: 10, initialConfidenceValue: 0.8),
                                                      RecipeSemiConstant(id: RecipeValue.hiddenValuePlaceholder.rawValue, value: 30,
                                                                         confidenceVariableId: 13, initialConfidenceValue: 0.6), // Semi constant should not normally be hidden
                                               RecipeSemiConstant(id: RecipeValue.grindSize.rawValue, value: 28,
                                                                  confidenceVariableId: 11, initialConfidenceValue: 0.5)]
